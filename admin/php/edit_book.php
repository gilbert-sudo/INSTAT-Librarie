...
if (isset($_POST['change'])) {
	if (!empty($_POST['langue']) and !empty($_POST['pages'])  and !empty($_POST['title']) and !empty($_POST['category']) and !empty($_POST['description'])) {
		if (isset($_POST['langue']) and isset($_POST['pages']) and isset($_POST['title']) and isset($_POST['category']) and isset($_POST['description'])) {
			...
			if ($ess == true || $extensionUpload == "xxx") {
				...
				if ($extensionValide == $extensionUpload || $extensionUpload == "yyy") {
					...
					echo $query . "<br>";
					$req->execute();
					header("Location: ../pages/gerer_book.php?page=$page");
					...
					header("Location: ../pages/edit_book.php?page=$page&mm=$msgmena&id_event=$id");
				}
			} else {
