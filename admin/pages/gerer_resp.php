                        ...
                        <td style="width: 20%;">
                          <div>
                            <table>
                              <tbody>
                                <td>
                                  <a class="btn btn-danger" onclick="return window.confirm('En êtes vous vraiment sûre?');" href="../php/del_resp.php?id=<?= $afresp['id']; ?>"><i class="glyphicon glyphicon-trash"></i></a><br>
                                </td>
                                <td>
                                  <a class="btn btn-primary" style="margin: 0px 10px;" href="edit_resp.php?id=<?= $afresp['id']; ?>"><i class="fa fa-edit"></i></a>
                                </td>
                              </tbody>
                            </table>
                          </div>
