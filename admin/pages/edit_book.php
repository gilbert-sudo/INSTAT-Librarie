        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              ...
              <!-- form start -->
              <form method="POST" id="uploadForm" enctype="multipart/form-data" action="../php/edit_book.php?id=<?= $editevent['PID']; ?>&page=<?= $page; ?>">
                <div class="box-body">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary" style="padding: 20px;">
              ...
              <div class="form-group">
                <tr>
                  <th scope="col"><button type="submit" class="btn btn-primary" name="change">Publier</button></th>
                  <th scope="col"><a class="btn btn-danger" href="gerer_book.php">Retour</a></th>
                </tr>
              </div>
