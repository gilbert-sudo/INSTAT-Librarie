              ...
              <form method="POST" id="uploadForm" enctype="multipart/form-data" action="#">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="1" oninput="validity.valid||(value='');" class="form-control" name="pages">
                  </div>
                </div>
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary" style="padding: 20px;">
              <div class="form-group">
                ...
                <input type="file" class="form-control btn btn-primary" style="text-align: left;" name="upFile" id="upFile">
              </div>
              <div class="form-group">
                <p><code id="cprogr">.progression</code></p>
              ...
              <div class="form-group" id="envoyer" style="display: none;">
                <button type="submit" class="btn btn-primary" name="envoyer">Publier</button>
              </div>

              </form>
              <?php include '../php/add_book.php'; ?><br>
