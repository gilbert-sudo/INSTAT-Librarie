              ...
              <form role="form" method="POST" enctype="multipart/form-data" action="#">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nom" placeholder="Entrer le nom de la nouveau catégorie:">
                  </div>

                  <div style="margin-top: 10px; margin-left:3px;">
                    <button type="submit" class="btn btn-primary" name="envoyer">Creer</button><br><br>
