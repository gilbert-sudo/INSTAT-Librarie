                  ...
                  <tbody>
                    ...
                    while ($afevent = $reqevent->fetch()) { ?>
                      <tr>
                        ...
                        <td>
                          <div style="margin-top: 16px;"><a class="btn btn-block btn-danger" onclick="return window.confirm('Êtes vous sûre de suprimmer ce livre?');" href="../php/del_event.php?id_book=<?= $afevent['PID']; ?>"><i class="glyphicon glyphicon-trash"></i></a><br>
                            <a class="btn btn-block btn-primary" href="edit_event.php?id_event=<?= $afevent['PID'];?>&page=<?= $currentPage;?>"><i class="fa fa-edit"></i></a>
                          </div>
                        </td>
                      </tr>
